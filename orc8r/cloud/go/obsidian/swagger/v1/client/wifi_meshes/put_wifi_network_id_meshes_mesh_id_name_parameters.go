...
/* PutWifiNetworkIDMeshesMeshIDNameParams contains all the parameters to send to the API endpoint
   for the put wifi network ID meshes mesh ID name operation.
...
// WithDefaults hydrates default values in the put wifi network ID meshes mesh ID name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutWifiNetworkIDMeshesMeshIDNameParams) WithDefaults() *PutWifiNetworkIDMeshesMeshIDNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put wifi network ID meshes mesh ID name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutWifiNetworkIDMeshesMeshIDNameParams) SetDefaults() {
