...
/* PutWifiNetworkIDNameNoContent describes a response with status code 204, with default header values.
...
/* PutWifiNetworkIDNameDefault describes a response with status code -1, with default header values.
