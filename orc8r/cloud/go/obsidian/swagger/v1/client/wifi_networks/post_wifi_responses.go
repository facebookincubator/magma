...
/* PostWifiCreated describes a response with status code 201, with default header values.
...
/* PostWifiDefault describes a response with status code -1, with default header values.
