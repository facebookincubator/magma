...
export default function FEGGatewayConnectionStatus() {
  ...
  const getServiceHealthStatus = serviceStatus => {
    ...
    return UNENABLED_SERVICE;
  };
  const isServiceStatusInactive = serviceStatus => {
    return (
      serviceStatus === UNAVAILABLE_SERVICE ||
      serviceStatus === UNENABLED_SERVICE
    );
  };
    ...
    [
      {
        ...
        status: gxGyConnectionStatus === HEALTHY_SERVICE,
      ...
      },
      {
        ...
        status: swxConnectionStatus === HEALTHY_SERVICE,
      ...
      },
      {
        ...
        status: s6aConnectionStatus === HEALTHY_SERVICE,
